            ...
            renderPopover={
              <div className="bg-white relative shadow-md rounded-sm border border-gray-200">
                <div className="flex flex-col py-2 pr-28 pl-3">
                  <button className="py-2 px-3 hover:text-orange-500 cursor-pointer">
                    Tiếng Việt
                  </button>
                  <button className="py-2 px-3 hover:text-orange-500 cursor-pointer mt-2">
                    English
                  </button>
                </div>
              </div>
                ...
                <div className="bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm">
                  <div className="p-2">
                    ...
                    <div className="flex mt-6 items-center justify-between">
                      ...
                      <button className="capitalize bg-orange-600 hover:opacity-80 px-4 py-2 rounded-sm text-white">
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
